    ...
    <div className="">
      <header className="flex flex-col md:flex-row justify-center items-center w-full relative">
        ...
        <div className="md:absolute left-[1.25%]  top-[45%] w-[95%] md:w-[33.33%] order-2 md:order-1 text-left">
          <h3 className="text-[1.15rem] md:text-[1.5rem] font-bold text-[#141449]">Vishal S. Gupta</h3>
          <p className="mt-[0rem] text-[#141449] text-[0.800rem] md:text-[1.1rem]">
          ...
          <div className="flex gap-[1rem] mt-[1rem] text-[#141449]">
            <a
              href="https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile"
              target="_blank"
              className="text-[#141449] hover:text-[#ff5f49] text-[1.5rem] md:text-[1.5rem] transition-transform duration-300 transform hover:scale-125"
            >
            ...
            <a
              href="tel:+9773146258"
              className="text-[#141449] hover:text-[#ff5f49] text-[1.4rem] md:text-[1.4rem] transition-transform duration-300 transform hover:scale-125"
            >
        ...
        <div className="absolute flex justify-end items-center  md:right-[55%] md:top-[6rem]  right-[15.5rem] top-[18%] w-[22rem] md:w-[33.33%]">
          <img
            ...
            src="data:image/svg+xml,%3csvg%20...%3e"
        ...
        <div className="absolute right-[-0.1rem]  top-[9%] w-[59vw] md:w-[26vw] md:top-[28%] md:right-[0.5rem] text-left">
          <h3 className="text-[1.15rem] md:text-[1.8rem] font-bold text-[#141449]">&lt;Coder/&gt;</h3>
          <p className="mt-[0rem] text-[#141449] text-[3.6vw] md:text-[1.5rem]">
